...
import {default as TaskbarSelectie} from './TaskbarSelectie';
import {default as ListenIcon} from './ListenIcon';
...
export * from './header';
export * from './footer';
export {DropdownLarge,DropdownMedium,TaskbarSelectie,DropdownLargeAdditions,Loading,Modal,Taskbar,ListenIcon,AudioPlayer,RiderPage,InfoIcon}